  ...
  class WebApp < Sinatra::Base
    ...
    get '/prepare/:type' do
      ...
      return <<~EOT
        ...
        sed --in-place -e 's|linux16.*|linux16 $IPXEPATH dhcp \\\\&\\\\& chain http://#{settings.my_ip}:#{settings.my_port}/boot/#{type}|' /etc/grub.d/20_ipxe
        update-grub
        # reboot
      EOT
    end
